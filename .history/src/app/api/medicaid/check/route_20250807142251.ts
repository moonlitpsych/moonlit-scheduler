...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        console.log('📋 UHIN Config:', {
            hasUsername: !!UHIN_CONFIG.username,
            hasPassword: !!UHIN_CONFIG.password,
            providerNPI: UHIN_CONFIG.providerNPI,
            providerName: UHIN_CONFIG.providerName
        });
