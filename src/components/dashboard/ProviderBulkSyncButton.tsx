...
interface ProviderBulkSyncButtonProps {
  onSyncComplete?: () => void
}
...
export default function ProviderBulkSyncButton({ onSyncComplete }: ProviderBulkSyncButtonProps) {
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>✅ Next appointment times, providers, payers, and statuses are current</li>
