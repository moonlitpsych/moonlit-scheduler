...
import { Partner, CreatePartnerRequest } from '@/types/partner-types'
...
export function CreatePartnerModal({ onClose, onPartnerCreated }: CreatePartnerModalProps) {
