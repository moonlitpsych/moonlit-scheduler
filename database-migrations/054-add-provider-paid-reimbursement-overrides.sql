-- Migration 054: Add provider_paid and reimbursement manual overrides to v_appointments_grid
-- Purpose: Allow manual override of provider_paid_cents, provider_paid_date, and reimbursement_cents
-- Date: 2025-10-30
...
-- NEW: Manual override for provider_paid_cents
...
-- NEW: Manual override for provider_paid_date
...
-- NEW: Manual override for reimbursement_cents
