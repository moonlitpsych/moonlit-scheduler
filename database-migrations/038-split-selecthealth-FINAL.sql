...
BEGIN
    ...
    IF EXISTS (
        ...
        IF EXISTS (
            ...
            RAISE NOTICE '✅ Step 7: Cloned % credentialing workflows to commercial payer', v_cloned_count;
        ELSE
            RAISE NOTICE '✅ Step 7: No credentialing workflows to clone (skipped)';
        END IF;
    ELSE
        RAISE NOTICE '✅ Step 7: Credentialing workflows table does not exist (skipped)';
    END IF;
END $$;
